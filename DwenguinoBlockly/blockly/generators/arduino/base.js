...
Blockly.Arduino.motor_1_2 = function() {
  // Boolean values HIGH and LOW.
  var code = (this.getFieldValue('NUM') == '1') ? '1' : '2';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.led_LD1_LD2 = function() {
  // Boolean values HIGH and LOW.
  var code = (this.getFieldValue('PIN') == 'LD1') ? 'LD1' : 'LD2';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.sensor_OS = function() {
  // Boolean values HIGH and LOW.
  var code = this.getFieldValue('PIN')
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.mode_sensor = function() {
  // Boolean values HIGH and LOW.
  var code = this.getFieldValue('PIN')
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
